...
public partial class Pages_ShoppingCart : System.Web.UI.Page
{
    ...
    {
        // Get the ID of current logged in user and display items in Cart
    ...
    private void CreateShopTable(List<Cart>purchaseList, out double subTotal)
    {
        ...
        foreach(Cart cart in purchaseList)
        {
            ...
            // Create list with numbers from 1 to 20
            ...
            TableCell a2 = new TableCell { Text = string.Format("<h4>{0}</h4>{1}<br/>In Stock", product.Name, "Item No: " + product.ID),
